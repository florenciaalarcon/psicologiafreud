...
<?php if ($usuarios->idUsuario->Visible) { // idUsuario ?>
	<div id="r_idUsuario" class="form-group">
		<label id="elh_usuarios_idUsuario" class="col-sm-2 control-label ewLabel"><?php echo $usuarios->idUsuario->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $usuarios->idUsuario->CellAttributes() ?>>
<span id="el_usuarios_idUsuario">
<span<?php echo $usuarios->idUsuario->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $usuarios->idUsuario->EditValue ?></p></span>
</span>
...
<?php echo $usuarios->idUsuario->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } else { ?>
<span id="el_usuarios_idNivel">
<select data-table="usuarios" data-field="x_idNivel" data-value-separator="<?php echo $usuarios->idNivel->DisplayValueSeparatorAttribute() ?>" id="x_idNivel" name="x_idNivel"<?php echo $usuarios->idNivel->EditAttributes() ?>>
<?php echo $usuarios->idNivel->SelectOptionListHtml("x_idNivel") ?>
</select>
