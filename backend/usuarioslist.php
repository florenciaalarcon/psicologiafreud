...
class cusuarios_list extends cusuarios {
	...
	function RenderRow() {
		...
		$sWhereWrk = "";
		$this->idNivel->LookupFilters = array();
...
fusuarioslist.Lists["x_idNivel"] = {"LinkField":"x_idNivel","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"niveles"};
...
<?php if ($usuarios->idUsuario->Visible) { // idUsuario ?>
	<?php if ($usuarios->SortUrl($usuarios->idUsuario) == "") { ?>
		<th data-name="idUsuario"><div id="elh_usuarios_idUsuario" class="usuarios_idUsuario"><div class="ewTableHeaderCaption"><?php echo $usuarios->idUsuario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="idUsuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->idUsuario) ?>',1);"><div id="elh_usuarios_idUsuario" class="usuarios_idUsuario">
...
<?php if ($usuarios->contrasenia->Visible) { // contrasenia ?>
	<?php if ($usuarios->SortUrl($usuarios->contrasenia) == "") { ?>
		<th data-name="contrasenia"><div id="elh_usuarios_contrasenia" class="usuarios_contrasenia"><div class="ewTableHeaderCaption"><?php echo $usuarios->contrasenia->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="contrasenia"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->contrasenia) ?>',1);"><div id="elh_usuarios_contrasenia" class="usuarios_contrasenia">
...
<?php if ($usuarios->idNivel->Visible) { // idNivel ?>
	<?php if ($usuarios->SortUrl($usuarios->idNivel) == "") { ?>
		<th data-name="idNivel"><div id="elh_usuarios_idNivel" class="usuarios_idNivel"><div class="ewTableHeaderCaption"><?php echo $usuarios->idNivel->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="idNivel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->idNivel) ?>',1);"><div id="elh_usuarios_idNivel" class="usuarios_idNivel">
...
?>
	<?php if ($usuarios->idUsuario->Visible) { // idUsuario ?>
		<td data-name="idUsuario"<?php echo $usuarios->idUsuario->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_idUsuario" class="usuarios_idUsuario">
...
<?php echo $usuarios->contrasenia->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->idNivel->Visible) { // idNivel ?>
		<td data-name="idNivel"<?php echo $usuarios->idNivel->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_idNivel" class="usuarios_idNivel">
