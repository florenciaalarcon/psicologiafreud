...
var CurrentForm = fnivelesdelete = new ew_Form("fnivelesdelete", "delete");
...
?>
<form name="fnivelesdelete" id="fnivelesdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($niveles_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $niveles_delete->Token ?>">
<?php } ?>
...
<?php if ($niveles->idNivel->Visible) { // idNivel ?>
		<th><span id="elh_niveles_idNivel" class="niveles_idNivel"><?php echo $niveles->idNivel->FldCaption() ?></span></th>
<?php } ?>
<?php if ($niveles->denominacion->Visible) { // denominacion ?>
		<th><span id="elh_niveles_denominacion" class="niveles_denominacion"><?php echo $niveles->denominacion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $niveles_delete->RowCnt ?>_niveles_idNivel" class="niveles_idNivel">
...
<span id="el<?php echo $niveles_delete->RowCnt ?>_niveles_denominacion" class="niveles_denominacion">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $niveles_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fnivelesdelete.Init();
