...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'archivos'))
		$this->Page_Terminate("archivoslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'categorias_blog'))
			$this->Page_Terminate("categorias_bloglist.php");
		if ($Security->AllowList(CurrentProjectID() . 'entradas_blog'))
			$this->Page_Terminate("entradas_bloglist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'paginas_estaticas'))
			$this->Page_Terminate("paginas_estaticaslist.php");
