...
$entradas_blog_add = NULL; // Initialize page object first

class centradas_blog_add extends centradas_blog {
	...
	// Page object name
	var $PageObjName = 'entradas_blog_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "entradas_blogview.php")
...
// Create page object
if (!isset($entradas_blog_add)) $entradas_blog_add = new centradas_blog_add();

// Page init
$entradas_blog_add->Page_Init();

// Page main
$entradas_blog_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$entradas_blog_add->Page_Render();
?>
...
var CurrentForm = fentradas_blogadd = new ew_Form("fentradas_blogadd", "add");

// Validate form
fentradas_blogadd.Validate = function() {
...
fentradas_blogadd.Form_CustomValidate = 
...
fentradas_blogadd.ValidateRequired = true;
<?php } else { ?>
fentradas_blogadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fentradas_blogadd.Lists["x_idCategoria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"categorias_blog"};
...
<?php if (!$entradas_blog_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $entradas_blog_add->ShowPageHeader(); ?>
<?php
$entradas_blog_add->ShowMessage();
?>
<form name="fentradas_blogadd" id="fentradas_blogadd" class="<?php echo $entradas_blog_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($entradas_blog_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $entradas_blog_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("fentradas_blogadd", "x_contenido", 35, 4, <?php echo ($entradas_blog->contenido->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $entradas_blog_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fentradas_blogadd.Init();
</script>
<?php
$entradas_blog_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$entradas_blog_add->Page_Terminate();
?>
