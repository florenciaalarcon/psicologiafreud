...
$categorias_blog = NULL;

//
// Table class for categorias_blog
//
class ccategorias_blog extends cTable {
	var $id;
	var $denominacion;
	var $idMenu;
	var $orden;
	...
	function __construct() {
		...
		$this->TableVar = 'categorias_blog';
		$this->TableName = 'categorias_blog';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`categorias_blog`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('categorias_blog', 'categorias_blog', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// denominacion
		$this->denominacion = new cField('categorias_blog', 'categorias_blog', 'x_denominacion', 'denominacion', '`denominacion`', '`denominacion`', 200, -1, FALSE, '`denominacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->denominacion->Sortable = TRUE; // Allow sort
		$this->fields['denominacion'] = &$this->denominacion;

		// idMenu
		$this->idMenu = new cField('categorias_blog', 'categorias_blog', 'x_idMenu', 'idMenu', '`idMenu`', '`idMenu`', 3, -1, FALSE, '`idMenu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// orden
		$this->orden = new cField('categorias_blog', 'categorias_blog', 'x_orden', 'orden', '`orden`', '`orden`', 5, -1, FALSE, '`orden`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`categorias_blog`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`idMenu` ASC,`orden` ASC,`denominacion` ASC";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "categorias_bloglist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("categorias_blogview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("categorias_blogview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "categorias_blogadd.php?" . $this->UrlParm($parm);
		else
			$url = "categorias_blogadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("categorias_blogedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("categorias_blogadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("categorias_blogdelete.php", $this->UrlParm());
	}
