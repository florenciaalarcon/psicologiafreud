...
class cusuarios extends cTable {
	...
	function __construct() {
		...
		// contrasenia
		$this->contrasenia = new cField('usuarios', 'usuarios', 'x_contrasenia', 'contrasenia', '`contrasenia`', '`contrasenia`', 200, -1, FALSE, '`contrasenia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
