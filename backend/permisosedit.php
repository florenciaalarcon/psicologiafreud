...
<p class="form-control-static"><?php echo $permisos->idNivel->EditValue ?></p></span>
</span>
<input type="hidden" data-table="permisos" data-field="x_idNivel" name="x_idNivel" id="x_idNivel" value="<?php echo ew_HtmlEncode($permisos->idNivel->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $permisos->tabla->EditValue ?></p></span>
</span>
<input type="hidden" data-table="permisos" data-field="x_tabla" name="x_tabla" id="x_tabla" value="<?php echo ew_HtmlEncode($permisos->tabla->CurrentValue) ?>">
