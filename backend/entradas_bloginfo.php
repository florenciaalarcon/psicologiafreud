...
//
// Table class for entradas_blog
//
class centradas_blog extends cTable {
	var $id;
	var $idCategoria;
	var $titulo;
	var $descripcion;
	...
	function __construct() {
		...
		$this->TableVar = 'entradas_blog';
		$this->TableName = 'entradas_blog';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`entradas_blog`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('entradas_blog', 'entradas_blog', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// idCategoria
		$this->idCategoria = new cField('entradas_blog', 'entradas_blog', 'x_idCategoria', 'idCategoria', '`idCategoria`', '`idCategoria`', 19, -1, FALSE, '`idCategoria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// titulo
		$this->titulo = new cField('entradas_blog', 'entradas_blog', 'x_titulo', 'titulo', '`titulo`', '`titulo`', 200, -1, FALSE, '`titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->titulo->Sortable = TRUE; // Allow sort
		$this->fields['titulo'] = &$this->titulo;

		// descripcion
		$this->descripcion = new cField('entradas_blog', 'entradas_blog', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagenPrincipal
		$this->imagenPrincipal = new cField('entradas_blog', 'entradas_blog', 'x_imagenPrincipal', 'imagenPrincipal', '`imagenPrincipal`', '`imagenPrincipal`', 200, -1, TRUE, '`imagenPrincipal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagenPrincipal->Sortable = TRUE; // Allow sort
		$this->fields['imagenPrincipal'] = &$this->imagenPrincipal;

		// contenido
		$this->contenido = new cField('entradas_blog', 'entradas_blog', 'x_contenido', 'contenido', '`contenido`', '`contenido`', 201, -1, FALSE, '`contenido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->contenido->Sortable = TRUE; // Allow sort
		$this->fields['contenido'] = &$this->contenido;

		// fechaCreacion
		$this->fechaCreacion = new cField('entradas_blog', 'entradas_blog', 'x_fechaCreacion', 'fechaCreacion', '`fechaCreacion`', 'DATE_FORMAT(`fechaCreacion`, \'%Y/%m/%d\')', 135, 0, FALSE, '`fechaCreacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// usuarioCreacion
		$this->usuarioCreacion = new cField('entradas_blog', 'entradas_blog', 'x_usuarioCreacion', 'usuarioCreacion', '`usuarioCreacion`', '`usuarioCreacion`', 200, -1, FALSE, '`usuarioCreacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->usuarioCreacion->Sortable = TRUE; // Allow sort
		$this->fields['usuarioCreacion'] = &$this->usuarioCreacion;

		// fechaModificacion
		$this->fechaModificacion = new cField('entradas_blog', 'entradas_blog', 'x_fechaModificacion', 'fechaModificacion', '`fechaModificacion`', 'DATE_FORMAT(`fechaModificacion`, \'%Y/%m/%d\')', 135, 0, FALSE, '`fechaModificacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// usuarioModificacion
		$this->usuarioModificacion = new cField('entradas_blog', 'entradas_blog', 'x_usuarioModificacion', 'usuarioModificacion', '`usuarioModificacion`', '`usuarioModificacion`', 200, -1, FALSE, '`usuarioModificacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`entradas_blog`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("entradas_blogview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("entradas_blogview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "entradas_blogadd.php?" . $this->UrlParm($parm);
		else
			$url = "entradas_blogadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("entradas_blogedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("entradas_blogadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("entradas_blogdelete.php", $this->UrlParm());
	}
