...
<?php if ($usuarios->idUsuario->Visible) { // idUsuario ?>
		<th><span id="elh_usuarios_idUsuario" class="usuarios_idUsuario"><?php echo $usuarios->idUsuario->FldCaption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_idUsuario" class="usuarios_idUsuario">
